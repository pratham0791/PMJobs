    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="sticky top-0 z-50 bg-white border-b border-gray-200 shadow-sm">
        <div className="px-5 flex justify-between items-center py-4">
          ...
          <div className="flex items-center gap-4">
            <p className="max-sm:hidden text-gray-700 font-medium">Welcome to PMJobs</p>
            <div className="relative group">
              ...
              <div className="absolute z-10 right-0 top-0 hidden group-hover:block text-black rounded pt-12">
                <ul className="list-none bg-white rounded-lg shadow-xl border border-gray-200 p-1 m-0 text-sm min-w-[140px]">
                  <li className="cursor-pointer hover:bg-blue-50 px-4 py-2.5 rounded-md transition-colors duration-150 text-gray-700 hover:text-blue-600 font-medium">
                    Logout
                  </li>
                </ul>
              </div>
      ...
      <div className="flex items-start">
        ...
        <div className="inline-block min-h-screen border-r border-gray-200 bg-white">
          <h2 className="text-xl font-bold text-center py-6 text-gray-800 border-b border-gray-200">Admin Dashboard</h2>
